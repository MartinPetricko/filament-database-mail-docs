...
## [Unreleased](https://github.com/martinpetricko/filament-database-mail/compare/1.2.2...HEAD)

## [1.2.2](https://github.com/martinpetricko/filament-database-mail/compare/2.0.3...1.2.2) - 2025-10-21

**Full Changelog**: https://github.com/MartinPetricko/filament-database-mail/compare/1.2.1...1.2.2

## [2.0.3](https://github.com/martinpetricko/filament-database-mail/compare/2.0.2...2.0.3) - 2025-10-20

### What's Changed

* Fix ExceptionsAction url generation by @MartinPetricko in https://github.com/MartinPetricko/filament-database-mail/pull/16
* Bump stefanzweifel/git-auto-commit-action from 6 to 7 by @dependabot[bot] in https://github.com/MartinPetricko/filament-database-mail/pull/15

**Full Changelog**: https://github.com/MartinPetricko/filament-database-mail/compare/2.0.2...2.0.3
